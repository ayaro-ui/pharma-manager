    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forme', models.CharField(choices=[('comprime', 'Comprimé'), ('sirop', 'Sirop'), ('injection', 'Injection'), ('pommade', 'Pommade'), ('capsule', 'Capsule'), ('autre', 'Autre')], max_length=50, verbose_name='Forme galénique')),
